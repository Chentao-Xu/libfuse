...
FUSE_SYMVER("old_fuse_session_loop_mt_312", "fuse_session_loop_mt@@FUSE_3.12")
...
int old_fuse_session_loop_mt_32(struct fuse_session *se, struct fuse_loop_config_v1 *config_v1);
...
int old_fuse_session_loop_mt_32(struct fuse_session *se, struct fuse_loop_config_v1 *config_v1)
{
	...
	err = fuse_session_loop_mt_32(se, config);
...
int old_fuse_session_loop_mt_31(struct fuse_session *se, int clone_fd)
{
	...
	err = old_fuse_session_loop_mt_312(se, config);
